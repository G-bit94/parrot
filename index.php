        ...
        <div class="row align-items-center g-5 py-5">
            <div class="col-lg-6">
                ...
                <p class="lead mb-4">Write essays, articles, emails, ads... and so much more!
                    You'll be amazed how great <?php echo $site_name; ?> speaks to the desires of your audience - at a fraction of the cost.</p>
            ...
            <div class="col-10 col-sm-8 col-lg-6 overflow-hidden">
                <img src="<?php echo $base_url; ?>/assets/img/main-transparent.png" class="d-block mx-lg-auto img-fluid rounded-lg-5" alt="" width="700" loading="lazy">
            </div>
        </div>
    </div>
</div>
...
<div class="container px-4 py-5" id="services">
    <h1 class="display-5 fw-bold"><?php echo $site_name; ?> is for you</h1>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        <div class="feature col" type="button">
            <div class="border rounded-5 shadow-sm pt-5 px-3 pb-3">
                <div class="feature-icon">
                    <img src="<?php echo $base_url; ?>/assets/img/typing.png" alt="" />
                </div>
        ...
        <div class="feature col" type="button">
            <div class="border rounded-5 shadow-sm pt-5 px-3 pb-3">
                <div class="feature-icon">
                    <img src="<?php echo $base_url; ?>/assets/img/digital-marketing.png" alt="" />
                </div>
        ...
        <div class="feature col" type="button">
            <div class="border rounded-5 shadow-sm pt-5 px-3 pb-3 ">
                <div class="feature-icon">
                    <img src="<?php echo $base_url; ?>/assets/img/developer.png" alt="" />
                </div>
        ...
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
            <div class="d-flex flex-column align-items-start gap-2">
                ...
                <p class="text-muted">From magical converting content for your blog, to user bios and product descriptions, anything goes.
                    <?php echo $site_name; ?> generates text from scratch. It is an AI assistant that can write for you in any style or format you want.
            ...
            <div class="row row-cols-1 row-cols-sm-2 g-4 d-flex">
                <div class="d-flex flex-column gap-2 p-1">
                    <div class="border rounded-5 shadow p-3">
                        ...
                        <p class="text-muted"><?php echo $site_name; ?> is trained on human-written SEO content so you can <strong>create search engine optimized content</strong> in minutes!</p>
                    </div>
                </div>
...
<div class="container col-xxl-8 mt-3 px-1 py-5">
    <div class="row align-items-center g-5 py-5">
        <div class="col-10 col-sm-8 col-lg-7 overflow-hidden border shadow-lg rounded-5">
            <img src="<?php echo $base_url; ?>/assets/img/dashboard.png" class="d-block mx-lg-auto img-fluid rounded-lg-5" alt="" width="700" loading="lazy">
        </div>
        <div class="col-lg-5">
            <div class="ms-5">
                <h4 class="lh-1 mb-4"><strong>We know creating quality content is time-consuming, but it doesn't have to be.</strong></h4>
                <p class="lead text-muted mb-4">Our AI allows you to write unique, naturally flowing content with just the click of a button, drastically cutting down writing time. That's why writers love it.</p>
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
...
<div class="masthead">
    <div class="container col-xxl-8 mt-3 px-1 py-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                <h3 class="lh-1 mb-4"><strong><?php echo $site_name; ?> gives you writing superpowers</strong></h3>
            ...
            <div class="col-10 col-sm-8 col-lg-6 overflow-hidden bg-white border shadow-lg rounded-5">
                ...
                <div class="mt-1">
                    <img src="<?php echo $base_url; ?>/assets/img/woman-parrot-dashboard-transparent.png" class="d-block mx-lg-auto img-fluid rounded-lg-3" alt="" width="700" loading="lazy">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3 g-2">
            <div class="col text-dark mt-2" data-bs="fade-up" data-bs-duration="300">
                <div class="p-4 bg-light shadow-sm border rounded-3">
                    <div class="d-flex justify-content-start align-items-center">
                        <img src="<?php echo $base_url; ?>/assets/img/reviews/4FNY3NGQEHYZJMKTTQINBZQKTH-min.jpg" alt="" width="35" height="35" class="rounded-circle mx-2" />
                        <p class="m-0">Anshul Jain</p>
                    </div>
                    <p class="mt-3"></p>
                    <p>After trying out all the other AI writing tools (Jarvis etc.), I stumbled upon <?php echo $site_name; ?>. And I'm glad I did. It's helped me double my writing output myself, and I'm training my writing team to use it as well. Took less than a month for me to recover my investment in the LTD - absolutely worth it. And Kelvin is one of the best developers I've seen - always prompt to respond and he's actively developing it further. Can't wait for <?php echo $site_name; ?> to go all the way to the moon!</p>
                    <p></p>
            ...
            <div class="col text-dark mt-2" data-bs="fade-up" data-bs-duration="300">
                <div class="p-4 bg-light shadow-sm border rounded-3">
                    <div class="d-flex justify-content-start align-items-center">
                        <img src="<?php echo $base_url; ?>/assets/img/reviews/ZXN8VGV4NELE5F2WOORYVI90TH-min.jpg" alt="" width="35" height="35" class="rounded-circle mx-2">
                        <p class="m-0">Marcos Ruvalcaba</p>
                    </div>
                    <p class="mt-3"></p>
                    <p><?php echo $site_name; ?> is perfect for those of you who are serious about taking advantage of a world-class AI writing tool. &nbsp;</p>
            ...
            <div class="col text-dark mt-2" data-bs="fade-up" data-bs-duration="300">
                <div class="p-4 bg-light shadow-sm border rounded-3">
                    <div class="d-flex justify-content-start align-items-center">
                        <img src="<?php echo $base_url; ?>/assets/img/reviews/profile-min.png" alt="" width="35" height="35" class="rounded-circle mx-2">
                        <p class="m-0">Catherine Rzecki</p>
                    </div>
                    <p class="mt-3"></p>
                    <p>I only took 1 hour ago to produce a beautiful blog post. I have to tell you ... this <?php echo $site_name; ?> is phenomenal !! I bought Jarvis only 2 days ago but it's NOTHING compared to this.
                        ...
                        but with <?php echo $site_name; ?> I didn't need to rewrite anything. I also have Spin Rewriter but again I have to spend so much time making so many changes because the finished article made no sense.
                        I'll be cancelling Jarvis, for sure!! And I won't be using Spin Rewriter again. I'm very slow with <?php echo $site_name; ?> naturally, but when I've read all the help documents and done a tour, I can see I'll be using it every day.
            ...
            <div class="col text-dark mt-2" data-bs="fade-up" data-bs-duration="300">
                <div class="p-4 bg-light shadow-sm border rounded-3">
                    <div class="d-flex justify-content-start align-items-center">
                        <img src="<?php echo $base_url; ?>/assets/img/reviews/P2HTGIRNW3XJMC8LFBA1YE1XTH-min.jpg" alt="" width="35" height="35" class="rounded-circle mx-2">
                        <p class="m-0">Max Bissolati</p>
                    </div>
                    <p class="mt-3"></p>
                    <p>It's a really great product, in what is becoming a competitive niche.</p>
                    <p>I find myself using <?php echo $site_name; ?> every day and I look forward to seeing it evolve in the coming years. The community on Facebook, along with Kelvin, seems to be the secret sauce for such an amazing product.</p>
                    <p>I can't recommend <?php echo $site_name; ?> any more highly! :)</p>
                    <p>To the moon 🚀</p>
                    <p></p>
                    <div class="d-flex justify-content-between">
            ...
            <div class="col text-dark mt-2" data-bs="fade-up" data-bs-duration="300">
                <div class="p-4 bg-light shadow-sm border rounded-3">
                    <div class="d-flex justify-content-start align-items-center">
                        <img src="<?php echo $base_url; ?>/assets/img/reviews/OGHMWK0HFPPJDTD8TVDIHMLZTH-min.jpg" alt="" width="35" height="35" class="rounded-circle mx-2">
                        <p class="m-0">Alaa Bananaamah</p>
                    </div>
                    <p class="mt-3"></p>
                    <p>I've been using <?php echo $site_name; ?> for a while now, and it's really amazing how much it can help you produce high-quality content quickly. It has a very simple and easy-to-use UI, which makes it a joy to work with.
...
<div class="masthead mt-5 py-5">
    <div class="px-4 mt-5 py-5 text-center">
        <h4><strong class="display-5 fw-bolder my-5"><?php echo $site_name; ?> isn't just your writing assistant. It is your wingman...</strong></h4>
        <div class="col-lg-6 mx-auto my-5">
