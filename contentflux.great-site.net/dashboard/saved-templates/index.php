                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr class="rounded-3 card-body shadow-sm reg-rows">
                                    ...
                                    <td class="p-1 border-0" onclick="fetchSingleItem('<?php echo $row['unique_id']; ?>');"><strong><small><?php echo truncStringToNrstWord($text, 3); ?></small></strong></td>
                                    <td class="p-1 border-0" onclick="fetchSingleItem('<?php echo $row['unique_id']; ?>');"><small class="mb-0"><?php echo truncStringToNrstWord($text, 15); ?></small></td>
