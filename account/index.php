    ...
    <div class="border-bottom mt-5 p-5">
        ...
        <div class="row p-1">
            <div class="col-md-2 m-1">
                <div class="py-5 bg-light rounded-5 shadow-sm">
                        ...
                        <div class="tab-content" id="menuTabContent">
                            <div class="tab-pane fade show active mt-3" id="details" role="tabpanel" aria-labelledby="details-tab">
                                <div class="row row-cols-1 row-cols-md-2 container-fluid mt-3 mb-5 py-2">
                                    <div class="col">
                                        <div class="card border mb-4 rounded-5 shadow-sm p-3">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <button class="mt-3 mb-2 btn btn-sm rounded-3 btn-primary bg-gradient" id="pwd_reset_btn" onclick="editUserDetails();">
                                ...
                                <div class="row row-cols-1 row-cols-md-2 container-fluid mt-3 mb-5 py-2">
                                    <div class="col">
                                        <div class="card border mb-4 rounded-3 shadow-sm p-3">
                                            ...
                                            <div class="mt-4 p-2 d-flex justify-content-between border rounded-5">
                                                <div>
                                                ...
                                                <div class="vr"></div>
                                                <div>
                                                    <span>Renewed on: <?php echo date('d M Y', strtotime($row_sub["date"])); ?></span>
                                                </div>
                                            </div>
                                            <?php if ($active_sub != 2) { ?>
