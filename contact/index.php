<div class="px-4 text-center py-2" id="contactus">
    ...
    <div class="row row-cols-1 row-cols-md-3 my-5">
        <div class="col my-3">
            <div class="col mr-auto text-center">
                ...
                <button class="btn btn-lg bg-custom-dark text-light my-5" onclick="startChat()"><i class="bi bi-chat-left"></i> &nbsp;Start chat</button>
            </div>
        </div>
        <div class="col my-3">
            <p class="fs-2">OR</p>
    ...
    <button class="btn btn-sm btn-primary my-2 mb-3" id="start-tour-btn"><i class="bi bi-signpost-split fs-5"></i>&nbsp;Take a site tour</button>
</div>